      ...
      <div class="row" id="contact-page">
          ...
          <div class="col-sm-6 col-sm-4">
              ...
              <address class="siteaddress">
                ...
                <p><i class="fa fa-envelope-open "></i> Email : info@onlinetutormumbai.online <br>onlinetutormumbai@gmail.com</p>
                <p><i class="fa fa-chrome "></i><a href="http://onlinetutormumbai.online"> onlinetutormumbai.online</a></p>
                <p><i class="fa fa-phone-square "></i> Contact Number : +91-8080346142</p>
              </address>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                              ...
                              <div class="form-group">
                                  ...
                                  <input id="form_email" type="email" name="email" class="form-control" placeholder="Enter email *" required="required" data-error="Valid email is required.">
                                  <div class="help-block with-errors"></div>
                              </div>
                              <div class="form-group">
                                  <label for="form_phone">Phone</label>
                                  <input id="form_phone" type="tel" name="phone" class="form-control" placeholder="Enter phone">
                                  <div class="help-block with-errors"></div>
                              </div>
                            </div>
                            <div>
